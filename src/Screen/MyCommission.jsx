...
export default function MyCommission() {
  ...
  return (
    ...
    <h2 className="text-2xl font-semibold mb-4 text-center">University Commissions List</h2>
            ...
            <tr key={uni._id} className="hover:bg-gray-100">
              <td className="border border-gray-300 px-4 py-2 text-center">
                <img
                  ...
                  className="w-32 h-16 rounded-md mx-auto"
                />
              </td>
              <td className="border border-gray-300 px-4 py-2 text-center">{uni.university.universityName}</td>
              <td className="border border-gray-300 px-4 py-2 text-center">{uni.university.vertical}</td>
